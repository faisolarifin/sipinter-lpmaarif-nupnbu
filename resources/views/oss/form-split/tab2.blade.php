<div class="tab d-none">
    <div class="row">
        <div class="col-12 col-sm-6">
            <div class="mb-3">
                <label for="lokasi_usaha" class="form-label required">Lokasi Kegiatan Usaha</label>
        ...
        <div class="col-12 col-sm-6">
            <div class="mb-3">
                <label for="luas_lahan_usaha" class="form-label required">Luas lahan yang digunakan untuk kegiatan usaha (M2)</label>
    ...
    <div class="row">
        <div class="col-12 col-sm-6">
            <div class="mb-3">
                <label for="apakah_sudah_menempati_lahan" class="form-label required">Apakah Anda sudah menempati lahan tersebut?</label>
        ...
        <div class="col-12 col-sm-6">
            <div class="mb-3">
                <label for="status_lahan" class="form-label required">Status Lahan</label>
    ...
    <div class="row-milik-sendiri">
        <div class="row">
            <div class="col-12 col-sm-6">
                <div class="mb-3">
                    <label for="ms_instansi_izin" class="form-label required">Nama Instansi Penerbit Izin</label>
            ...
            <div class="col-12 col-sm-6">
                <div class="mb-3">
                    <label for="ms_nomor_izin" class="form-label required">Nomor Izin yang tertera pada surat</label>
        ...
        <div class="row">
            <div class="col-12 col-sm-6">
                <div class="mb-3">
                    <label for="ms_tgl_terbit" class="form-label required">Tanggal Terbit</label>
            ...
            <div class="col-12 col-sm-6">
                <div class="mb-3">
                    <label for="ms_tgl_expired" class="form-label required">Tanggal habis masa berlaku</label>
    ...
    <div class="row-sewa" style="display:none;">
        <div class="row">
            <div class="col-12 col-sm-6">
                <div class="mb-3">
                    <label for="sw_pemilik_lahan" class="form-label required">Nama Pemilik Lahan</label>
            ...
            <div class="col-12 col-sm-6">
                <div class="mb-3">
                    <label for="sw_nomor_perjanjian" class="form-label required">Nomor Perjanjian</label>
        ...
        <div class="row">
            <div class="col-12 col-sm-6">
                <div class="mb-3">
                    <label for="sw_tgl_perjanjian" class="form-label required">Tanggal Perjanjian</label>
            ...
            <div class="col-12 col-sm-6">
                <div class="mb-3">
                    <label for="sw_tgl_expired" class="form-label required">Tanggal Habis Masa Berlaku</label>
    ...
    <div class="row-pinjam-pakai" style="display:none;">
        <div class="row">
            <div class="col-12 col-sm-6">
                <div class="mb-3">
                    <label for="pp_pemilik_lahan" class="form-label required">Nama Pemilik Lahan</label>
            ...
            <div class="col-12 col-sm-6">
                <div class="mb-3">
                    <label for="pp_nomor_perjanjian" class="form-label required">Nomor Perjanjian</label>
        ...
        <div class="row">
            <div class="col-12 col-sm-6">
                <div class="mb-3">
                    <label for="pp_tgl_perjanjian" class="form-label required">Tanggal Perjanjian</label>
            ...
            <div class="col-12 col-sm-6">
                <div class="mb-3">
                    <label for="pp_tgl_expired" class="form-label required">Tanggal Habis Masa Berlaku</label>
