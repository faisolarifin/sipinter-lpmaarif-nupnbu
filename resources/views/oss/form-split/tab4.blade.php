<div class="tab d-none">
    <div class="row">
        <div class="col-12">
            <div class="mb-3">
                <label for="apakah_lokasi_sekolah_lintas_perbatasan" class="form-label required">Apakah Lokasi Sekolah berada dalam lintas provinsi/kabupaten/kota (Perbatasan)</label>
    ...
    <div class="row">
        <div class="col-12 col-sm-6">
            <div class="mb-3">
                <label for="alamat_sekolah" class="form-label required">Alamat Sekolah (Jalan/RT-RW)</label>
    ...
    <div class="row">
        <div class="col-12 col-sm-6">
            <div class="mb-3">
                <label for="kelurahan" class="form-label required">Desa/Kelurahan</label>
    ...
    <div class="row">
        <div class="col-12">
            <div class="mb-3">
                <label for="apakah_proyek_strategi_nasional" class="form-label required">Apakah merupakan proyek Strategis Nasional?</label>
    ...
    <div class="row">
        <div class="col-12">
            <div class="mb-3">
                <label for="rencana_teknis_bangunan" class="form-label required">Rencana teknis bangunan/rencana induk kawasan</label>
                ...
                @if($oss->rencana_teknis_bangunan)<a href="{{ route('oss.file', $oss->rencana_teknis_bangunan) }}" target="_blank"><strong>{{ \App\Helpers\Strings::getFileName($oss->rencana_teknis_bangunan) }} <i class="ti ti-download"></i> </strong></a> @endif
                <div class="invalid-feedback">
    ...
    <div class="row">
        <div class="col-12">
            <div class="mb-3">
                <label for="kawasan_lokasi_usaha" class="form-label required">Kawasan Lokasi Usaha</label>
    ...
    <div class="row row-kli" style="display: none;">
        <div class="col-12">
            <div class="mb-3">
                <label for="klu_nama_kawasan_industri" class="form-label required">Nama Kawasan Industri</label>
