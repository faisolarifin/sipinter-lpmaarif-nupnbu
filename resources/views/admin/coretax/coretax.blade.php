            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#verifikasi"
                        ...
                        ({{ count($coretaxVer) }})</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="buka-expiry-tab" data-bs-toggle="tab" data-bs-target="#buka-expiry"
                        type="button" role="tab" aria-controls="buka-expiry" aria-selected="true">BUKA EXPIRY
                        ({{ count($coretaxExp) }})</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="revisi-tab" data-bs-toggle="tab" data-bs-target="#revisi" type="button"
                        role="tab" aria-controls="revisi" aria-selected="true">REVISI
                        ({{ count($coretaxRev) }})</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#proses" type="button"
                        role="tab" aria-controls="proses" aria-selected="false">SEDANG DIPROSES
                        ({{ count($coretaxPro) }})</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#satpen" type="button"
                        role="tab" aria-controls="satpen" aria-selected="false">SATPEN
                        ({{ count($coretaxSatpen) }})</button>
                </li>
                @if (!in_array(auth()->user()->role, ['admin cabang']))
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#cabang"
                            type="button" role="tab" aria-controls="cabang" aria-selected="false">CABANG
                            ({{ count($coretaxCab) }})</button>
                    </li>
                    @if (!in_array(auth()->user()->role, ['admin wilayah']))
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#wilayah"
                                type="button" role="tab" aria-controls="wilayah" aria-selected="false">WILAYAH
                                ({{ count($coretaxWil) }})</button>
                        </li>
                    @endif
                @endif
            </ul>
