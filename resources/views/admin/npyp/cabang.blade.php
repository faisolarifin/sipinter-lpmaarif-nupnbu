                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h4 class="card-title fw-bold text-success mb-2">
                                <i class="ti ti-building me-2"></i>REKAP DATA NPYP TINGKAT CABANG
                            </h4>
                            <p class="text-muted mb-0">
                                Halaman ini menampilkan rekapitulasi seluruh data Nomor Pokok Yayasan Penyelenggara (NPYP) 
                                yang telah terdaftar di tingkat cabang. Data mencakup informasi lengkap NPYP 
                                beserta operator yang bertanggung jawab di setiap cabang wilayah.
                            </p>
                        </div>
                        <div class="col-md-4 text-end">
                            <div class="bg-light-success p-3 rounded">
                                <h6 class="text-success mb-1">Total Data</h6>
                                <h4 class="text-success mb-0" id="totalData">-</h4>
                                <small class="text-muted">NPYP Cabang</small>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card w-100">
                <div class="card-body pt-3">
                    ...
                    <div class="alert alert-success d-flex align-items-center mb-3" role="alert">
                        ...
                        <div>
                            <strong>Informasi:</strong> Tabel di bawah ini menampilkan data NPYP yang terdaftar untuk setiap cabang di seluruh wilayah. 
                                ...
                                <table class="table table-hover mb-0" id="npypCabangTable">
                                    <thead class="table-success">
                                        <tr>
                                            ...
                                            <th width="18%">
                                                <i class="ti ti-building-community text-white me-1"></i>Cabang
                                            </th>
                                            <th width="18%">
