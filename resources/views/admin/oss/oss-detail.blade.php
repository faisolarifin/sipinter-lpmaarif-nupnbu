                        ...
                        <div class="table-responsive mt-4">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>@if($oss->bukti_bayar) <a href="{{ route('a.oss.file', $oss->bukti_bayar) }}" class="btn btn-sm btn-secondary">Lihat File <i class="ti ti-eye"></i></a>@endif</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>@if($oss->file_izin_lama) <a href="{{ route('a.oss.file', $oss->file_izin_lama) }}" class="btn btn-sm btn-secondary">Lihat File <i class="ti ti-eye"></i></a> @endif</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>@if($oss->ms_file_lampiran) <a href="{{ route('a.oss.file', $oss->ms_file_lampiran) }}" class="btn btn-sm btn-secondary">Lihat File <i class="ti ti-eye"></i></a> @endif</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>@if($oss->sw_file_lampiran) <a href="{{ route('a.oss.file', $oss->sw_file_lampiran) }}" class="btn btn-sm btn-secondary">Lihat File <i class="ti ti-eye"></i></a> @endif</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>@if($oss->pp_file_lampiran) <a href="{{ route('a.oss.file', $oss->pp_file_lampiran) }}" class="btn btn-sm btn-secondary">Lihat File <i class="ti ti-eye"></i></a> @endif</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>@if($oss->imb_file_lampiran) <a href="{{ route('a.oss.file', $oss->imb_file_lampiran) }}" class="btn btn-sm btn-secondary">Lihat File <i class="ti ti-eye"></i></a> @endif</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>@if($oss->slf_file_lampiran) <a href="{{ route('a.oss.file', $oss->slf_file_lampiran) }}" class="btn btn-sm btn-secondary">Lihat File <i class="ti ti-eye"></i></a> @endif</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>@if($oss->file_peta_polygon) <a href="{{ route('a.oss.file', $oss->file_peta_polygon) }}" class="btn btn-sm btn-secondary">Lihat File <i class="ti ti-eye"></i></a> @endif</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>@if($oss->rencana_teknis_bangunan) <a href="{{ route('a.oss.file', $oss->rencana_teknis_bangunan) }}" class="btn btn-sm btn-secondary">Lihat File <i class="ti ti-eye"></i></a> @endif</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>@if($oss->file_lampiran_kkpr) <a href="{{ route('a.oss.file', $oss->file_lampiran_kkpr) }}" class="btn btn-sm btn-secondary">Lihat File <i class="ti ti-eye"></i></a> @endif</td>
                                </tr>
                                <tr>
                                    <td><strong>Data Rencana Investasi : Pembelian dan Pematangan Tanah (Rp)?</strong></td>
                                    <td>:</td>
                                ...
                                <tr>
                                    <td><strong>Data Rencana Investasi : Mesin Peralatan Dalam Negeri (Rp)?</strong></td>
                                    <td>:</td>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>@if($oss->amdal_file_lampiran) <a href="{{ route('a.oss.file', $oss->amdal_file_lampiran) }}" class="btn btn-sm btn-secondary">Lihat File <i class="ti ti-eye"></i></a> @endif</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>@if($oss->uklupl_file_lampiran) <a href="{{ route('a.oss.file', $oss->uklupl_file_lampiran) }}" class="btn btn-sm btn-secondary">Lihat File <i class="ti ti-eye"></i></a> @endif</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
