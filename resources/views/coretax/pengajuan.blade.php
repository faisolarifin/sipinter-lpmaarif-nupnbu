                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            @if(!$coretax || @$coretax->status == 'final aprove')
                                <a href="{{ route('coretax.new') }}" class="btn btn-primary mx-1"><i class="ti ti-new-section"></i> Pengajuan Baru</a>
                            @endif
                    ...
                    @if($coretax)
                        ...
                        <div class="row justify-content-center">
                            <div class="col col-sm-11 border px-2 py-2">
                                <form action="{{ route('coretax.save', $coretax->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="card-body pb-3 pt-3">
                                        <div class="row">
                                            <div class="col-12 col-sm-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="wilayah" name="wilayah" value="{{ $coretax->wilayah->nm_prov }}" placeholder="Nama Wilayah" readonly>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="cabang" name="cabang" value="{{ $coretax->cabang->nama_pc }}" placeholder="Nama Cabang" readonly>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="nm_sekolah" name="nm_sekolah" value="{{ $coretax->satpen->nm_satpen }}" placeholder="Nama Sekolah" readonly>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control  @error('nm_pic') is-invalid @enderror" id="nm_pic" name="nm_pic" value="{{ $coretax->nama_pic }}" placeholder="Nama PIC">
                                                    <div class="invalid-feedback">
                                                        @error('nm_pic') {{ $message }} @enderror
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="mb-3">
                                                    <label for="whatsapp_pic" class="form-label required">Nomor Whatsapp PIC</label>
                                                    <input type="text" class="form-control  @error('whatsapp_pic') is-invalid @enderror" id="whatsapp_pic" name="whatsapp_pic" value="{{ $coretax->whatsapp_pic }}" placeholder="Nomor Whatsapp PIC">
                                                    <div class="invalid-feedback">
                                                        @error('whatsapp_pic') {{ $message }} @enderror
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label for="nik_pic" class="form-label required">Akun Coretax/NIK PIC</label>
                                                    <input type="text" class="form-control  @error('nik_pic') is-invalid @enderror" id="nik_pic" name="nik_pic" value="{{ $coretax->nik_pic }}" placeholder="Akun Coretax/NIK PIC">
                                                    <div class="invalid-feedback">
                                                        @error('nik_pic') {{ $message }} @enderror
                                                    </div>
                                                </div>
                                            </div>    
                                        </div>                                
                                ...
                                <table class="table table-bordered mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-bottom-0">
                                            <h6 class="mb-0">Pengurus Wilayah {{ $coretax->wilayah->nm_prov }}</h6>
                                        </td>
                                    </tr>
