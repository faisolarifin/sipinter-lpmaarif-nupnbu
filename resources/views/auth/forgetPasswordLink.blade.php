            ...
            <form action="{{ route('reset.send') }}" method="post">
                ...
                <div class="sip-field">
                    ...
                    <div class="sip-input-wrap">
                        ...
                        <button type="button" class="sip-toggle-eye" onclick="var p=document.getElementById('new_password');p.type=p.type==='password'?'text':'password';">
                ...
                <div class="sip-field">
                    ...
                    <div class="sip-input-wrap">
                        ...
                        <button type="button" class="sip-toggle-eye" onclick="var p=document.getElementById('password_confirm');p.type=p.type==='password'?'text':'password';">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M2 12s3.6-7 10-7 10 7 10 7-3.6 7-10 7-10-7-10-7Z" stroke="currentColor" stroke-width="1.8"/><circle cx="12" cy="12" r="3" stroke="currentColor" stroke-width="1.8"/></svg>
                        </button>
                    </div>
